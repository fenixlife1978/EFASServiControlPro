module.exports = [
"[project]/node_modules/@capacitor-mlkit/barcode-scanning/dist/esm/web.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class BarcodeScannerWeb extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WebPlugin"] {
    constructor(){
        super(...arguments);
    ...
    async startScan(options) {
        ...
        this.stream = await navigator.mediaDevices.getUserMedia({
            video: {
                facingMode: {
                    ideal: (options === null || options === void 0 ? void 0 : options.lensFacing) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2d$mlkit$2f$barcode$2d$scanning$2f$dist$2f$esm$2f$definitions$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LensFacing"].Front ? 'user' : 'environment'
                }
            },
            audio: false
        });
    ...
    handleScannedBarcodes(barcodes) {
        const result = {
            barcodes: barcodes.map((barcode)=>({
                    ...
                    valueType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$capacitor$2d$mlkit$2f$barcode$2d$scanning$2f$dist$2f$esm$2f$definitions$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BarcodeValueType"].Unknown
                }))
        };
...
//# sourceMappingURL=node_modules_%40capacitor-mlkit_barcode-scanning_dist_esm_web_38da5890.js.map