  ...
  const startScan = async () => {
    try {
      ...
      if (barcodes.length > 0) {
        ...
        // 1. Actualizar en RTDB (dispositivos/ - nodo principal)
        ...
        await update(deviceRef, {
          ...
          lastSeen: now,
          estado: 'activo',
          admin_mode_enable: false,      // Modo técnico desactivado por defecto
          shield_mode_enable: false,     // Modo blindado desactivado por defecto
          hardware: {
        ...
        // 2. Sincronizar en status_dispositivos/ (para monitoreo en tiempo real)
        const statusRef = ref(rtdb, `status_dispositivos/${qrId}`);
        await update(statusRef, {
          ...
          InstitutoId: '',  // Se actualizará cuando se asigne aula/alumno
        ...
        if (snapshot.exists()) {
          ...
          localStorage.setItem('efas_device_id', qrId);
